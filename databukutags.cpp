void data_buku(){
    string list_judul_buku[20]= {"Beginning Ethical Hacking with Kali Linux", "Akuntansi Pengantar 1", "A-Z Psikologi", "Bangsa gagal", "The Hobbit 1", "Koala Kumal", "Negeri 5 Menara", "Satwa Terancam Bahaya", "TUILET", "Dear Nathan", "Perahu Kertas", "5 cm", "Rindu", "Memahami Film", "Sebuah Seni Bersikap Bodo Amat", "Rapijali", "Why? Camera – Kamera", "Wingit", "Belantik", "Runtuhnya Kerajaan Hindu Jawa"};
...
void data_tags(){
    ...
    SEO.push_back({"A-Z Psikologi", "psikologi, topik psikologi, kesehatan mental", 8.8});
    SEO.push_back({"Bangsa gagal", "karakteristik bangsa, nasionalisme, politik", 9.0});
    SEO.push_back({"The Hobbit 1", "gandalf, the hobbit, fiksi, petualangan, dongeng, fairytale", 6.6});
    ...
    SEO.push_back({"Sebuah Seni Bersikap Bodo Amat", "self improvement, motivasi, psikologi sosial", 8.9});
    ...
    SEO.push_back({"Runtuhnya Kerajaan Hindu Jawa", "sejarah, kerajaan, kerajaan Indonesia", 9.3});
}
